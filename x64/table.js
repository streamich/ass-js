...
exports.table = {
    ...
    mov: [{},
        ...
        { o: 0x88, ops: [table_1.rm8, table_1.rm8], dbit: true },
        // 89 /r MOV r/m16,r16 MR Valid Valid Move r16 to r/m16.
        // 8B /r MOV r16,r/m16 RM Valid Valid Move r/m16 to r16.
        { o: 0x89, ops: [table_1.rm16, table_1.rm16], dbit: true },
        // 89 /r MOV r/m32,r32 MR Valid Valid Move r32 to r/m32.
        // 8B /r MOV r32,r/m32 RM Valid Valid Move r/m32 to r32.
        { o: 0x89, ops: [table_1.rm32, table_1.rm32], dbit: true },
        // REX.W + 89 /r MOV r/m64,r64 MR Valid N.E. Move r64 to r/m64.
        // REX.W + 8B /r MOV r64,r/m64 RM Valid N.E. Move r/m64 to r64.
        { o: 0x89, ops: [table_1.rm64, table_1.rm64], dbit: true },
        ...
        { o: 0xB0, r: true, ops: [table_1.r8, table_1.imm8] },
        // B8+ rw iw MOV r16, imm16 OI Valid Valid Move imm16 to r16.
        { o: 0xB8, r: true, ops: [table_1.r16, table_1.imm16] },
        // B8+ rd id MOV r32, imm32 OI Valid Valid Move imm32 to r32.
        { o: 0xB8, r: true, ops: [table_1.r32, table_1.imm32] },
        // REX.W + B8+ rd io MOV r64, imm64 OI Valid N.E. Move imm64 to r64.
        { o: 0xB8, r: true, ops: [table_1.r64, table_1.imm64] },
        // C6 /0 ib MOV r/m8, imm8 MI Valid Valid Move imm8 to r/m8.
        // REX + C6 /0 ib MOV r/m8***, imm8 MI Valid N.E. Move imm8 to r/m8.
        { o: 0xC6, or: 0, ops: [table_1.rm8, table_1.imm8] },
        // C7 /0 iw MOV r/m16, imm16 MI Valid Valid Move imm16 to r/m16.
        { o: 0xC7, or: 0, ops: [table_1.rm16, table_1.imm16] },
        // C7 /0 id MOV r/m32, imm32 MI Valid Valid Move imm32 to r/m32.
        { o: 0xC7, or: 0, ops: [table_1.rm32, table_1.imm32] },
        // REX.W + C7 /0 io MOV r/m64, imm32 MI Valid N.E. Move imm32 sign extended to 64-bits to r/m64.
        { o: 0xC7, or: 0, ops: [table_1.rm64, table_1.imm32] },
    ],
