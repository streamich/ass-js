...
mnemonic_add_0.mnemonic                = "setnae";
...
const x86_mnemonic_variations_setnae = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setnae.defaultOperandSize = 32;

export default x86_mnemonic_variations_setnae;
