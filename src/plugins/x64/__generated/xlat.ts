...
mnemonic_add_0.mnemonic                = "xlat";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 215;
...
const x86_mnemonic_variations_xlat = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_xlat.defaultOperandSize = 32;

export default x86_mnemonic_variations_xlat;
