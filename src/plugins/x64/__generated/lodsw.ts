...
const x86_mnemonic_variations_lodsw = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_lodsw.defaultOperandSize = 32;

export default x86_mnemonic_variations_lodsw;
