...
mnemonic_add_0.mnemonic                = "setp";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3994;
...
const x86_mnemonic_variations_setp = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setp.defaultOperandSize = 32;

export default x86_mnemonic_variations_setp;
