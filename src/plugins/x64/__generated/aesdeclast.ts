...
mnemonic_add_0.mnemonic                = "aesdeclast";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997599;
...
const x86_mnemonic_variations_aesdeclast = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_aesdeclast.defaultOperandSize = 32;

export default x86_mnemonic_variations_aesdeclast;
