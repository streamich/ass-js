...
mnemonic_add_0.mnemonic                = "cvtps2dq";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688603;
...
const x86_mnemonic_variations_cvtps2dq = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtps2dq.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtps2dq;
