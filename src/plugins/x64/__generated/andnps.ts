...
mnemonic_add_0.mnemonic                = "andnps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3925;
...
const x86_mnemonic_variations_andnps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_andnps.defaultOperandSize = 32;

export default x86_mnemonic_variations_andnps;
