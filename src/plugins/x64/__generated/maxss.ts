...
mnemonic_add_0.mnemonic                = "maxss";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15929183;
...
const x86_mnemonic_variations_maxss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_maxss.defaultOperandSize = 32;

export default x86_mnemonic_variations_maxss;
