...
mnemonic_add_0.mnemonic                = "cmpxchg16b";
...
const x86_mnemonic_variations_cmpxchg16b = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmpxchg16b.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmpxchg16b;
