...
mnemonic_add_0.mnemonic                = "fcmovbe";
...
const x86_mnemonic_variations_fcmovbe = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fcmovbe.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcmovbe;
