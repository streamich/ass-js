...
mnemonic_add_0.mnemonic                = "movntdqa";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 14378;
...
const x86_mnemonic_variations_movntdqa = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_movntdqa.defaultOperandSize = 32;

export default x86_mnemonic_variations_movntdqa;
