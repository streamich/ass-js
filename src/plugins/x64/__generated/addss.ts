...
mnemonic_add_0.mnemonic                = "addss";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15929176;
...
const x86_mnemonic_variations_addss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_addss.defaultOperandSize = 32;

export default x86_mnemonic_variations_addss;
