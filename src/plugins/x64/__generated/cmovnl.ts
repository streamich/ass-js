...
mnemonic_add_0.mnemonic                = "cmovnl";
...
const x86_mnemonic_variations_cmovnl = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovnl.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovnl;
