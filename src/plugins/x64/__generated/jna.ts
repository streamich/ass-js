...
mnemonic_add_0.mnemonic                = "jna";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 118;
...
mnemonic_add_1.mnemonic                = "jna";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 3974;
...
const x86_mnemonic_variations_jna = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jna.defaultOperandSize = 32;

export default x86_mnemonic_variations_jna;
