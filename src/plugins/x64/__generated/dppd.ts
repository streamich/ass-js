...
mnemonic_add_0.mnemonic                = "dppd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997953;
...
const x86_mnemonic_variations_dppd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_dppd.defaultOperandSize = 32;

export default x86_mnemonic_variations_dppd;
