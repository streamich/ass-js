...
mnemonic_add_0.mnemonic                = "addpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688600;
...
const x86_mnemonic_variations_addpd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_addpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_addpd;
