...
mnemonic_add_0.mnemonic                = "vdivss";
...
const x86_mnemonic_variations_vdivss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vdivss.defaultOperandSize = 32;

export default x86_mnemonic_variations_vdivss;
