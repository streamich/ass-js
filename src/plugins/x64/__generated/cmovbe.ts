...
mnemonic_add_0.mnemonic                = "cmovbe";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 3910;
...
mnemonic_add_1.mnemonic                = "cmovbe";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 3910;
...
mnemonic_add_2.mnemonic                = "cmovbe";
mnemonic_add_2.operandSize             = 64;
mnemonic_add_2.opcode                  = 3910;
...
const x86_mnemonic_variations_cmovbe = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_cmovbe.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovbe;
