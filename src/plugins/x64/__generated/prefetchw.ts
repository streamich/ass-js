...
mnemonic_add_0.mnemonic                = "prefetchw";
...
const x86_mnemonic_variations_prefetchw = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_prefetchw.defaultOperandSize = 32;

export default x86_mnemonic_variations_prefetchw;
