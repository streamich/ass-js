...
mnemonic_add_0.mnemonic                = "vblendvps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 74;
mnemonic_add_0.operandTemplates        = [[a.xmm], [a.xmm], [a.xmm, a.m], [a.xmm]];
...
mnemonic_add_0.opEncoding              = "rvmr";
mnemonic_add_0.rex                     = null;
mnemonic_add_0.vex                     = {"vvvv":"NDS","L":0,"pp":1,"mmmmm":3,"W":0,"WIG":false};
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = [24];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "vblendvps";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 74;
mnemonic_add_1.operandTemplates        = [[a.ymm], [a.ymm], [a.ymm, a.m], [a.ymm]];
...
mnemonic_add_1.opEncoding              = "rvmr";
mnemonic_add_1.rex                     = null;
mnemonic_add_1.vex                     = {"vvvv":"NDS","L":1,"pp":1,"mmmmm":3,"W":0,"WIG":false};
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 63;
mnemonic_add_1.extensions              = [24];

const x86_mnemonic_variations_vblendvps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vblendvps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vblendvps;
