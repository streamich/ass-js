...
mnemonic_add_0.mnemonic                = "blendvps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997396;
...
const x86_mnemonic_variations_blendvps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_blendvps.defaultOperandSize = 32;

export default x86_mnemonic_variations_blendvps;
