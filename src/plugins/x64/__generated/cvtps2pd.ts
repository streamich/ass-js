...
mnemonic_add_0.mnemonic                = "cvtps2pd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3930;
...
const x86_mnemonic_variations_cvtps2pd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtps2pd.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtps2pd;
