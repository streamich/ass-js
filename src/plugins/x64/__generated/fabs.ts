...
mnemonic_add_0.mnemonic                = "fabs";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55777;
...
const x86_mnemonic_variations_fabs = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fabs.defaultOperandSize = 32;

export default x86_mnemonic_variations_fabs;
