...
mnemonic_add_0.mnemonic                = "fnstcw";
...
const x86_mnemonic_variations_fnstcw = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fnstcw.defaultOperandSize = 32;

export default x86_mnemonic_variations_fnstcw;
