...
mnemonic_add_0.mnemonic                = "cvtsd2ss";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15863642;
...
const x86_mnemonic_variations_cvtsd2ss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtsd2ss.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtsd2ss;
