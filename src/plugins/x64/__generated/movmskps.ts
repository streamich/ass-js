...
mnemonic_add_0.mnemonic                = "movmskps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3920;
...
const x86_mnemonic_variations_movmskps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_movmskps.defaultOperandSize = 32;

export default x86_mnemonic_variations_movmskps;
