...
const x86_mnemonic_variations_cmovz = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovz.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovz;
