...
mnemonic_add_0.mnemonic                = "fxam";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55781;
...
const x86_mnemonic_variations_fxam = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fxam.defaultOperandSize = 32;

export default x86_mnemonic_variations_fxam;
