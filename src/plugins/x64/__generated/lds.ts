...
mnemonic_add_0.mnemonic                = "lds";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 197;
...
mnemonic_add_1.mnemonic                = "lds";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 197;
...
const x86_mnemonic_variations_lds = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_lds.defaultOperandSize = 32;

export default x86_mnemonic_variations_lds;
