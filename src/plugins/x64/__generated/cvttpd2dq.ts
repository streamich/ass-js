...
mnemonic_add_0.mnemonic                = "cvttpd2dq";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688742;
...
const x86_mnemonic_variations_cvttpd2dq = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvttpd2dq.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvttpd2dq;
