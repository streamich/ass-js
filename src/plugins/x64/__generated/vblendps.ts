...
mnemonic_add_0.mnemonic                = "vblendps";
...
mnemonic_add_1.mnemonic                = "vblendps";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 12;
...
const x86_mnemonic_variations_vblendps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vblendps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vblendps;
