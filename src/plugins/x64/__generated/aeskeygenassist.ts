...
mnemonic_add_0.mnemonic                = "aeskeygenassist";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 998111;
mnemonic_add_0.operandTemplates        = [[a.xmm], [a.xmm, a.m], [a.imm8]];
...
mnemonic_add_0.extensions              = [12];

const x86_mnemonic_variations_aeskeygenassist = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_aeskeygenassist.defaultOperandSize = 32;

export default x86_mnemonic_variations_aeskeygenassist;
