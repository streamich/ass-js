...
const x86_mnemonic_variations_mulss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_mulss.defaultOperandSize = 32;

export default x86_mnemonic_variations_mulss;
