...
mnemonic_add_0.mnemonic                = "leave";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 201;
...
mnemonic_add_1.mnemonic                = "leave";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 201;
...
const x86_mnemonic_variations_leave = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_leave.defaultOperandSize = 32;

export default x86_mnemonic_variations_leave;
