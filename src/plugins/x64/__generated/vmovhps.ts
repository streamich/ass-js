...
mnemonic_add_0.mnemonic                = "vmovhps";
...
mnemonic_add_1.mnemonic                = "vmovhps";
...
const x86_mnemonic_variations_vmovhps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vmovhps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmovhps;
