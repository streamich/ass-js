...
mnemonic_add_0.mnemonic                = "rdseed";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 4039;
mnemonic_add_0.operandTemplates        = [[a.r]];
...
mnemonic_add_1.mnemonic                = "rdseed";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 4039;
mnemonic_add_1.operandTemplates        = [[a.r]];
...
mnemonic_add_2.mnemonic                = "rdseed";
mnemonic_add_2.operandSize             = 64;
mnemonic_add_2.opcode                  = 4039;
...
const x86_mnemonic_variations_rdseed = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_rdseed.defaultOperandSize = 32;

export default x86_mnemonic_variations_rdseed;
