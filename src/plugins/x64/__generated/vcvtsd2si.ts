...
mnemonic_add_0.mnemonic                = "vcvtsd2si";
mnemonic_add_0.operandSize             = 64;
mnemonic_add_0.opcode                  = 3885;
mnemonic_add_0.operandTemplates        = [[a.r], [a.xmm, a.m]];
...
mnemonic_add_1.mnemonic                = "vcvtsd2si";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 45;
mnemonic_add_1.operandTemplates        = [[a.r], [a.xmm, a.m]];
...
mnemonic_add_2.vex                     = {"vvvv":"","L":0,"pp":3,"mmmmm":1,"W":1,"WIG":false};
mnemonic_add_2.evex                    = null;
mnemonic_add_2.mode                    = 32;
mnemonic_add_2.extensions              = [24];

const x86_mnemonic_variations_vcvtsd2si = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_vcvtsd2si.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcvtsd2si;
