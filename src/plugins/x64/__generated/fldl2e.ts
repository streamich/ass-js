...
mnemonic_add_0.mnemonic                = "fldl2e";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55786;
...
const x86_mnemonic_variations_fldl2e = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fldl2e.defaultOperandSize = 32;

export default x86_mnemonic_variations_fldl2e;
