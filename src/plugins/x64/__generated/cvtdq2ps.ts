...
mnemonic_add_0.mnemonic                = "cvtdq2ps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3931;
...
const x86_mnemonic_variations_cvtdq2ps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtdq2ps.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtdq2ps;
