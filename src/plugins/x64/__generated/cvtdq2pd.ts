...
mnemonic_add_0.mnemonic                = "cvtdq2pd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15929318;
...
const x86_mnemonic_variations_cvtdq2pd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtdq2pd.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtdq2pd;
