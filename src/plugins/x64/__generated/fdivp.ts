...
mnemonic_add_1.mnemonic                = "fdivp";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 57081;
...
const x86_mnemonic_variations_fdivp = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_fdivp.defaultOperandSize = 32;

export default x86_mnemonic_variations_fdivp;
