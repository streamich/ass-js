...
mnemonic_add_0.mnemonic                = "fld1";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55784;
...
const x86_mnemonic_variations_fld1 = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fld1.defaultOperandSize = 32;

export default x86_mnemonic_variations_fld1;
