...
mnemonic_add_0.mnemonic                = "sysret";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 3847;
...
const x86_mnemonic_variations_sysret = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_sysret.defaultOperandSize = 32;

export default x86_mnemonic_variations_sysret;
