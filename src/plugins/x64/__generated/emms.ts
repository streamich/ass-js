...
mnemonic_add_0.mnemonic                = "emms";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 3959;
...
const x86_mnemonic_variations_emms = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_emms.defaultOperandSize = 32;

export default x86_mnemonic_variations_emms;
