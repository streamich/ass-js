...
mnemonic_add_0.mnemonic                = "setnbe";
...
const x86_mnemonic_variations_setnbe = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setnbe.defaultOperandSize = 32;

export default x86_mnemonic_variations_setnbe;
