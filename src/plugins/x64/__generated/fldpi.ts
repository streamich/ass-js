...
mnemonic_add_0.mnemonic                = "fldpi";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55787;
...
const x86_mnemonic_variations_fldpi = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fldpi.defaultOperandSize = 32;

export default x86_mnemonic_variations_fldpi;
