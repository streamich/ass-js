...
mnemonic_add_0.mnemonic                = "fucomip";
...
const x86_mnemonic_variations_fucomip = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fucomip.defaultOperandSize = 32;

export default x86_mnemonic_variations_fucomip;
