...
mnemonic_add_0.mnemonic                = "fsin";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55806;
...
const x86_mnemonic_variations_fsin = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fsin.defaultOperandSize = 32;

export default x86_mnemonic_variations_fsin;
