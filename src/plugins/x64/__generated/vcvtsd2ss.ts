...
mnemonic_add_0.mnemonic                = "vcvtsd2ss";
...
const x86_mnemonic_variations_vcvtsd2ss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vcvtsd2ss.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcvtsd2ss;
