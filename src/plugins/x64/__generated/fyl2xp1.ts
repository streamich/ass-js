...
mnemonic_add_0.mnemonic                = "fyl2xp1";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55801;
...
const x86_mnemonic_variations_fyl2xp1 = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fyl2xp1.defaultOperandSize = 32;

export default x86_mnemonic_variations_fyl2xp1;
