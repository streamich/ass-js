...
mnemonic_add_0.mnemonic                = "adcx";
mnemonic_add_0.operandSize             = 32;
mnemonic_add_0.opcode                  = 997622;
...
mnemonic_add_0.extensions              = [23];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "adcx";
mnemonic_add_1.operandSize             = 64;
mnemonic_add_1.opcode                  = 997622;
...
mnemonic_add_1.prefixes                = [102];
mnemonic_add_1.opEncoding              = "rm";
mnemonic_add_1.rex                     = null;
mnemonic_add_1.vex                     = null;
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 32;
mnemonic_add_1.extensions              = [23];

const x86_mnemonic_variations_adcx = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_adcx.defaultOperandSize = 32;

export default x86_mnemonic_variations_adcx;
