...
mnemonic_add_1.mnemonic                = "faddp";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 57025;
...
const x86_mnemonic_variations_faddp = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_faddp.defaultOperandSize = 32;

export default x86_mnemonic_variations_faddp;
