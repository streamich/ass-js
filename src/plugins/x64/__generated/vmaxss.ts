...
mnemonic_add_0.mnemonic                = "vmaxss";
...
const x86_mnemonic_variations_vmaxss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vmaxss.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmaxss;
