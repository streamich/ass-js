...
mnemonic_add_0.mnemonic                = "jnb";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 115;
...
mnemonic_add_1.mnemonic                = "jnb";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 3971;
...
const x86_mnemonic_variations_jnb = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jnb.defaultOperandSize = 32;

export default x86_mnemonic_variations_jnb;
