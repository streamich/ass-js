...
const x86_mnemonic_variations_jl = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jl.defaultOperandSize = 32;

export default x86_mnemonic_variations_jl;
