...
mnemonic_add_0.mnemonic                = "fldz";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55790;
...
const x86_mnemonic_variations_fldz = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fldz.defaultOperandSize = 32;

export default x86_mnemonic_variations_fldz;
