...
mnemonic_add_0.mnemonic                = "setnp";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3995;
...
const x86_mnemonic_variations_setnp = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setnp.defaultOperandSize = 32;

export default x86_mnemonic_variations_setnp;
