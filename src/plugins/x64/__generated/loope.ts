...
mnemonic_add_0.mnemonic                = "loope";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 225;
...
const x86_mnemonic_variations_loope = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_loope.defaultOperandSize = 32;

export default x86_mnemonic_variations_loope;
