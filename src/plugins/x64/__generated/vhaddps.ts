...
mnemonic_add_0.mnemonic                = "vhaddps";
...
mnemonic_add_1.mnemonic                = "vhaddps";
...
mnemonic_add_1.vex                     = {"vvvv":"NDS","L":1,"pp":3,"mmmmm":1,"W":1,"WIG":true};
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 63;
mnemonic_add_1.extensions              = [24];

const x86_mnemonic_variations_vhaddps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vhaddps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vhaddps;
