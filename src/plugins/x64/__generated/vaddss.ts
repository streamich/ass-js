...
mnemonic_add_0.mnemonic                = "vaddss";
...
const x86_mnemonic_variations_vaddss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vaddss.defaultOperandSize = 32;

export default x86_mnemonic_variations_vaddss;
