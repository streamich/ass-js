...
mnemonic_add_0.mnemonic                = "xrstor";
...
const x86_mnemonic_variations_xrstor = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_xrstor.defaultOperandSize = 32;

export default x86_mnemonic_variations_xrstor;
