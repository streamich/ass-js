...
mnemonic_add_0.mnemonic                = "sets";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3992;
...
const x86_mnemonic_variations_sets = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_sets.defaultOperandSize = 32;

export default x86_mnemonic_variations_sets;
