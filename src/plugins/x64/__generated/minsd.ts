...
mnemonic_add_0.mnemonic                = "minsd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15863645;
...
const x86_mnemonic_variations_minsd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_minsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_minsd;
