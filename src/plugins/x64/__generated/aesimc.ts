...
mnemonic_add_0.mnemonic                = "aesimc";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997595;
...
const x86_mnemonic_variations_aesimc = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_aesimc.defaultOperandSize = 32;

export default x86_mnemonic_variations_aesimc;
