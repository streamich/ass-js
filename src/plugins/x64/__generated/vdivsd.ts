...
mnemonic_add_0.mnemonic                = "vdivsd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 94;
...
mnemonic_add_1.mnemonic                = "vdivsd";
mnemonic_add_1.operandSize             = 128;
mnemonic_add_1.opcode                  = 94;
mnemonic_add_1.operandTemplates        = [[a.xmm], [a.xmm], [a.xmm, a.m]];
...
mnemonic_add_1.evex                    = {"vvvv":"NDS","L":0,"pp":3,"mmmmm":1,"W":1,"WIG":false};
mnemonic_add_1.mode                    = 63;
mnemonic_add_1.extensions              = [26];

const x86_mnemonic_variations_vdivsd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vdivsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vdivsd;
