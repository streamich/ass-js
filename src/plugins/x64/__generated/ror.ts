...
const x86_mnemonic_variations_ror = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
    mnemonic_add_3,
...
x86_mnemonic_variations_ror.defaultOperandSize = 32;

export default x86_mnemonic_variations_ror;
