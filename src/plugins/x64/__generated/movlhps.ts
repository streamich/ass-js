...
mnemonic_add_0.mnemonic                = "movlhps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3862;
...
const x86_mnemonic_variations_movlhps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_movlhps.defaultOperandSize = 32;

export default x86_mnemonic_variations_movlhps;
