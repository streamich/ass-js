...
mnemonic_add_0.mnemonic                = "jo";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 112;
...
mnemonic_add_1.mnemonic                = "jo";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 3968;
...
const x86_mnemonic_variations_jo = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jo.defaultOperandSize = 32;

export default x86_mnemonic_variations_jo;
