...
mnemonic_add_0.mnemonic                = "divsd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15863646;
...
const x86_mnemonic_variations_divsd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_divsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_divsd;
