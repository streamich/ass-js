...
mnemonic_add_0.mnemonic                = "loopnz";
...
const x86_mnemonic_variations_loopnz = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_loopnz.defaultOperandSize = 32;

export default x86_mnemonic_variations_loopnz;
