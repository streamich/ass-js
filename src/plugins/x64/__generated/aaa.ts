...
mnemonic_add_0.mnemonic                = "aaa";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55;
...
const x86_mnemonic_variations_aaa = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_aaa.defaultOperandSize = 32;

export default x86_mnemonic_variations_aaa;
