...
mnemonic_add_0.mnemonic                = "movddup";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15863570;
...
const x86_mnemonic_variations_movddup = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_movddup.defaultOperandSize = 32;

export default x86_mnemonic_variations_movddup;
