...
mnemonic_add_0.prefixes                = [242,15];
...
mnemonic_add_1.mnemonic                = "movsd";
mnemonic_add_1.operandSize             = 128;
mnemonic_add_1.opcode                  = 17;
...
mnemonic_add_1.prefixes                = [242,15];
...
const x86_mnemonic_variations_movsd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_movsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_movsd;
