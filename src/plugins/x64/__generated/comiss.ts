...
mnemonic_add_0.mnemonic                = "comiss";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3887;
...
const x86_mnemonic_variations_comiss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_comiss.defaultOperandSize = 32;

export default x86_mnemonic_variations_comiss;
