...
mnemonic_add_0.mnemonic                = "fchs";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55776;
...
const x86_mnemonic_variations_fchs = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fchs.defaultOperandSize = 32;

export default x86_mnemonic_variations_fchs;
