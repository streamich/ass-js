...
mnemonic_add_0.mnemonic                = "maskmovq";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 4087;
mnemonic_add_0.operandTemplates        = [[a.mm], [a.mm]];
...
const x86_mnemonic_variations_maskmovq = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_maskmovq.defaultOperandSize = 32;

export default x86_mnemonic_variations_maskmovq;
