...
mnemonic_add_0.mnemonic                = "ldmxcsr";
...
const x86_mnemonic_variations_ldmxcsr = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_ldmxcsr.defaultOperandSize = 32;

export default x86_mnemonic_variations_ldmxcsr;
