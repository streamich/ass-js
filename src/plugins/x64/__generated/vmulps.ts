...
mnemonic_add_0.mnemonic                = "vmulps";
...
mnemonic_add_1.mnemonic                = "vmulps";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 89;
...
const x86_mnemonic_variations_vmulps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vmulps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmulps;
