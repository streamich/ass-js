...
mnemonic_add_0.mnemonic                = "clflush";
...
const x86_mnemonic_variations_clflush = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_clflush.defaultOperandSize = 32;

export default x86_mnemonic_variations_clflush;
