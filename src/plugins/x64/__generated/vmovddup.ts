...
mnemonic_add_0.mnemonic                = "vmovddup";
...
mnemonic_add_1.mnemonic                = "vmovddup";
...
const x86_mnemonic_variations_vmovddup = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vmovddup.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmovddup;
