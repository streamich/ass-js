...
mnemonic_add_0.mnemonic                = "ficomp";
...
mnemonic_add_1.mnemonic                = "ficomp";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 218;
...
const x86_mnemonic_variations_ficomp = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_ficomp.defaultOperandSize = 32;

export default x86_mnemonic_variations_ficomp;
