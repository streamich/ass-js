...
mnemonic_add_0.mnemonic                = "vdpps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 64;
...
mnemonic_add_1.mnemonic                = "vdpps";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 64;
...
const x86_mnemonic_variations_vdpps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vdpps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vdpps;
