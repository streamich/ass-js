...
mnemonic_add_0.mnemonic                = "minss";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15929181;
...
const x86_mnemonic_variations_minss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_minss.defaultOperandSize = 32;

export default x86_mnemonic_variations_minss;
