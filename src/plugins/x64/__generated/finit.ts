...
mnemonic_add_0.mnemonic                = "finit";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 10214371;
...
const x86_mnemonic_variations_finit = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_finit.defaultOperandSize = 32;

export default x86_mnemonic_variations_finit;
