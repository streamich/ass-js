...
mnemonic_add_0.mnemonic                = "cvttpd2pi";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688556;
...
const x86_mnemonic_variations_cvttpd2pi = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvttpd2pi.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvttpd2pi;
