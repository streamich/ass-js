...
mnemonic_add_0.mnemonic                = "vcmpps";
...
mnemonic_add_1.mnemonic                = "vcmpps";
...
const x86_mnemonic_variations_vcmpps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vcmpps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcmpps;
