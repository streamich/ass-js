...
mnemonic_add_0.mnemonic                = "cvtpd2dq";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15863782;
...
const x86_mnemonic_variations_cvtpd2dq = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtpd2dq.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtpd2dq;
