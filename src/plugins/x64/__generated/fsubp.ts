...
mnemonic_add_1.mnemonic                = "fsubp";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 57065;
...
const x86_mnemonic_variations_fsubp = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_fsubp.defaultOperandSize = 32;

export default x86_mnemonic_variations_fsubp;
