...
mnemonic_add_0.mnemonic                = "setnle";
...
const x86_mnemonic_variations_setnle = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setnle.defaultOperandSize = 32;

export default x86_mnemonic_variations_setnle;
