...
mnemonic_add_0.mnemonic                = "bextr";
mnemonic_add_0.operandSize             = 32;
mnemonic_add_0.opcode                  = 247;
mnemonic_add_0.operandTemplates        = [[a.r], [a.r, a.m], [a.r]];
...
mnemonic_add_0.opEncoding              = "rmv";
mnemonic_add_0.rex                     = null;
mnemonic_add_0.vex                     = {"vvvv":"NDS","L":0,"pp":0,"mmmmm":2,"W":0,"WIG":false};
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = [9];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "bextr";
mnemonic_add_1.operandSize             = 64;
mnemonic_add_1.opcode                  = 247;
mnemonic_add_1.operandTemplates        = [[a.r], [a.r, a.m], [a.r]];
...
mnemonic_add_1.opEncoding              = "rmv";
mnemonic_add_1.rex                     = null;
mnemonic_add_1.vex                     = {"vvvv":"NDS","L":0,"pp":0,"mmmmm":2,"W":1,"WIG":false};
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 32;
mnemonic_add_1.extensions              = [9];

const x86_mnemonic_variations_bextr = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_bextr.defaultOperandSize = 32;

export default x86_mnemonic_variations_bextr;
