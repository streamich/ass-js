...
mnemonic_add_0.mnemonic                = "fprem";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55800;
...
const x86_mnemonic_variations_fprem = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fprem.defaultOperandSize = 32;

export default x86_mnemonic_variations_fprem;
