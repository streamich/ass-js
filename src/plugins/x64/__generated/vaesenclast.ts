...
mnemonic_add_0.mnemonic                = "vaesenclast";
...
const x86_mnemonic_variations_vaesenclast = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vaesenclast.defaultOperandSize = 32;

export default x86_mnemonic_variations_vaesenclast;
