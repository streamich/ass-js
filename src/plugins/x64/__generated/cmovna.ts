...
mnemonic_add_0.mnemonic                = "cmovna";
...
const x86_mnemonic_variations_cmovna = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovna.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovna;
