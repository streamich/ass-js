...
mnemonic_add_0.mnemonic                = "lzcnt";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 4029;
...
mnemonic_add_0.extensions              = [14];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "lzcnt";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 4029;
...
mnemonic_add_1.extensions              = [14];

const mnemonic_add_2 = new MnemonicX86;
mnemonic_add_2.mnemonic                = "lzcnt";
mnemonic_add_2.operandSize             = 64;
mnemonic_add_2.opcode                  = 4029;
...
mnemonic_add_2.prefixes                = [243];
mnemonic_add_2.opEncoding              = "rm";
mnemonic_add_2.rex                     = null;
mnemonic_add_2.vex                     = null;
mnemonic_add_2.evex                    = null;
mnemonic_add_2.mode                    = 63;
mnemonic_add_2.extensions              = [14];

const x86_mnemonic_variations_lzcnt = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_lzcnt.defaultOperandSize = 32;

export default x86_mnemonic_variations_lzcnt;
