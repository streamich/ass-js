...
mnemonic_add_0.mnemonic                = "xsaveopt";
...
const x86_mnemonic_variations_xsaveopt = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_xsaveopt.defaultOperandSize = 32;

export default x86_mnemonic_variations_xsaveopt;
