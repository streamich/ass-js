...
const x86_mnemonic_variations_insb = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_insb.defaultOperandSize = 32;

export default x86_mnemonic_variations_insb;
