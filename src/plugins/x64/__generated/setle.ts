...
mnemonic_add_0.mnemonic                = "setle";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3998;
...
const x86_mnemonic_variations_setle = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setle.defaultOperandSize = 32;

export default x86_mnemonic_variations_setle;
