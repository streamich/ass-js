...
mnemonic_add_0.mnemonic                = "cmovnz";
...
const x86_mnemonic_variations_cmovnz = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovnz.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovnz;
