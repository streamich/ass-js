...
mnemonic_add_0.mnemonic                = "cvtpi2pd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688554;
...
const x86_mnemonic_variations_cvtpi2pd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtpi2pd.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtpi2pd;
