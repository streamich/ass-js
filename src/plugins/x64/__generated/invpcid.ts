...
mnemonic_add_0.mnemonic                = "invpcid";
mnemonic_add_0.operandSize             = 32;
mnemonic_add_0.opcode                  = 14466;
...
mnemonic_add_0.extensions              = [13];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "invpcid";
mnemonic_add_1.operandSize             = 64;
mnemonic_add_1.opcode                  = 14466;
...
mnemonic_add_1.extensions              = [13];

const x86_mnemonic_variations_invpcid = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_invpcid.defaultOperandSize = 32;

export default x86_mnemonic_variations_invpcid;
