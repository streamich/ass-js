...
mnemonic_add_0.mnemonic                = "vhsubpd";
...
mnemonic_add_1.mnemonic                = "vhsubpd";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 125;
...
const x86_mnemonic_variations_vhsubpd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vhsubpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vhsubpd;
