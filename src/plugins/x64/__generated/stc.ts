...
mnemonic_add_0.mnemonic                = "stc";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 249;
...
const x86_mnemonic_variations_stc = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_stc.defaultOperandSize = 32;

export default x86_mnemonic_variations_stc;
