...
mnemonic_add_0.mnemonic                = "addsubpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688720;
...
const x86_mnemonic_variations_addsubpd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_addsubpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_addsubpd;
