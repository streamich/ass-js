...
mnemonic_add_0.mnemonic                = "setg";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3999;
...
const x86_mnemonic_variations_setg = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setg.defaultOperandSize = 32;

export default x86_mnemonic_variations_setg;
