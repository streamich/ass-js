...
mnemonic_add_0.mnemonic                = "cmovpo";
...
const x86_mnemonic_variations_cmovpo = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovpo.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovpo;
