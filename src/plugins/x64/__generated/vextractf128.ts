...
mnemonic_add_0.mnemonic                = "vextractf128";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 25;
mnemonic_add_0.operandTemplates        = [[a.xmm, a.m], [a.ymm], [a.imm8]];
...
mnemonic_add_0.vex                     = {"vvvv":"","L":1,"pp":1,"mmmmm":3,"W":0,"WIG":false};
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = null;

const x86_mnemonic_variations_vextractf128 = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vextractf128.defaultOperandSize = 32;

export default x86_mnemonic_variations_vextractf128;
