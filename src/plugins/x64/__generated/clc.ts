...
mnemonic_add_0.mnemonic                = "clc";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 248;
...
const x86_mnemonic_variations_clc = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_clc.defaultOperandSize = 32;

export default x86_mnemonic_variations_clc;
