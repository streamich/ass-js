...
mnemonic_add_0.mnemonic                = "fldln2";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55789;
...
const x86_mnemonic_variations_fldln2 = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fldln2.defaultOperandSize = 32;

export default x86_mnemonic_variations_fldln2;
