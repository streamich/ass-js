...
mnemonic_add_0.mnemonic                = "seto";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3984;
...
const x86_mnemonic_variations_seto = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_seto.defaultOperandSize = 32;

export default x86_mnemonic_variations_seto;
