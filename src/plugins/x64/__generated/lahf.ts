...
mnemonic_add_0.mnemonic                = "lahf";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 159;
...
const x86_mnemonic_variations_lahf = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_lahf.defaultOperandSize = 32;

export default x86_mnemonic_variations_lahf;
