...
mnemonic_add_0.mnemonic                = "fsubrp";
mnemonic_add_0.operandSize             = 80;
mnemonic_add_0.opcode                  = 222;
mnemonic_add_0.operandTemplates        = [[a.st], [a.st0]];
...
mnemonic_add_1.mnemonic                = "fsubrp";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 57057;
...
const x86_mnemonic_variations_fsubrp = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_fsubrp.defaultOperandSize = 32;

export default x86_mnemonic_variations_fsubrp;
