...
mnemonic_add_0.mnemonic                = "vpabsw";
...
mnemonic_add_1.mnemonic                = "vpabsw";
...
mnemonic_add_1.vex                     = {"vvvv":"","L":1,"pp":1,"mmmmm":2,"W":1,"WIG":true};
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 63;
mnemonic_add_1.extensions              = [25];

const x86_mnemonic_variations_vpabsw = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vpabsw.defaultOperandSize = 32;

export default x86_mnemonic_variations_vpabsw;
