...
mnemonic_add_0.mnemonic                = "maskmovdqu";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688759;
mnemonic_add_0.operandTemplates        = [[a.xmm], [a.xmm]];
...
const x86_mnemonic_variations_maskmovdqu = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_maskmovdqu.defaultOperandSize = 32;

export default x86_mnemonic_variations_maskmovdqu;
