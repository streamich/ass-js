...
mnemonic_add_0.mnemonic                = "setns";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3993;
...
const x86_mnemonic_variations_setns = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setns.defaultOperandSize = 32;

export default x86_mnemonic_variations_setns;
