...
mnemonic_add_0.mnemonic                = "lfs";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 4020;
mnemonic_add_0.operandTemplates        = [[a.r, a.m], [a.m]];
...
mnemonic_add_1.mnemonic                = "lfs";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 4020;
mnemonic_add_1.operandTemplates        = [[a.r, a.m], [a.m]];
...
mnemonic_add_2.mnemonic                = "lfs";
mnemonic_add_2.operandSize             = 64;
mnemonic_add_2.opcode                  = 4020;
mnemonic_add_2.operandTemplates        = [[a.r, a.m], [a.m]];
...
const x86_mnemonic_variations_lfs = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_lfs.defaultOperandSize = 32;

export default x86_mnemonic_variations_lfs;
