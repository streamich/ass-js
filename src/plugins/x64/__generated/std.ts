...
mnemonic_add_0.mnemonic                = "std";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 253;
...
const x86_mnemonic_variations_std = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_std.defaultOperandSize = 32;

export default x86_mnemonic_variations_std;
