...
mnemonic_add_0.mnemonic                = "fucomp";
...
const x86_mnemonic_variations_fucomp = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fucomp.defaultOperandSize = 32;

export default x86_mnemonic_variations_fucomp;
