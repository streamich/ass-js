...
mnemonic_add_0.mnemonic                = "vandnpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 85;
...
mnemonic_add_1.mnemonic                = "vandnpd";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 85;
...
const x86_mnemonic_variations_vandnpd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vandnpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vandnpd;
