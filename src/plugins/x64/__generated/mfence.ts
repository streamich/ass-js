...
mnemonic_add_0.mnemonic                = "mfence";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 1027824;
...
const x86_mnemonic_variations_mfence = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_mfence.defaultOperandSize = 32;

export default x86_mnemonic_variations_mfence;
