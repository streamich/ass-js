...
mnemonic_add_0.mnemonic                = "bound";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 98;
...
mnemonic_add_1.mnemonic                = "bound";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 98;
...
const x86_mnemonic_variations_bound = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_bound.defaultOperandSize = 32;

export default x86_mnemonic_variations_bound;
