...
mnemonic_add_0.mnemonic                = "fscale";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55805;
...
const x86_mnemonic_variations_fscale = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fscale.defaultOperandSize = 32;

export default x86_mnemonic_variations_fscale;
