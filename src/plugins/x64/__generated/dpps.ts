...
mnemonic_add_0.mnemonic                = "dpps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997952;
...
const x86_mnemonic_variations_dpps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_dpps.defaultOperandSize = 32;

export default x86_mnemonic_variations_dpps;
