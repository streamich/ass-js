...
mnemonic_add_0.mnemonic                = "movapd";
...
mnemonic_add_1.mnemonic                = "movapd";
...
const x86_mnemonic_variations_movapd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_movapd.defaultOperandSize = 32;

export default x86_mnemonic_variations_movapd;
