...
mnemonic_add_0.mnemonic                = "cld";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 252;
...
const x86_mnemonic_variations_cld = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cld.defaultOperandSize = 32;

export default x86_mnemonic_variations_cld;
