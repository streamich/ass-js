...
mnemonic_add_0.mnemonic                = "vcvtsi2ss";
mnemonic_add_0.operandSize             = 32;
mnemonic_add_0.opcode                  = 42;
mnemonic_add_0.operandTemplates        = [[a.xmm], [a.xmm], [a.r, a.m]];
...
mnemonic_add_0.vex                     = {"vvvv":"NDS","L":0,"pp":2,"mmmmm":1,"W":0,"WIG":false};
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = [24];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "vcvtsi2ss";
mnemonic_add_1.operandSize             = 64;
mnemonic_add_1.opcode                  = 42;
mnemonic_add_1.operandTemplates        = [[a.xmm], [a.xmm], [a.r, a.m]];
...
mnemonic_add_1.vex                     = {"vvvv":"NDS","L":0,"pp":2,"mmmmm":1,"W":1,"WIG":false};
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 63;
mnemonic_add_1.extensions              = [24];

const x86_mnemonic_variations_vcvtsi2ss = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vcvtsi2ss.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcvtsi2ss;
