...
const x86_mnemonic_variations_arpl = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_arpl.defaultOperandSize = 32;

export default x86_mnemonic_variations_arpl;
