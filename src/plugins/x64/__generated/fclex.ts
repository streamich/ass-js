...
mnemonic_add_0.mnemonic                = "fclex";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 10214370;
...
const x86_mnemonic_variations_fclex = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fclex.defaultOperandSize = 32;

export default x86_mnemonic_variations_fclex;
