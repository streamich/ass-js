...
mnemonic_add_0.mnemonic                = "fcompp";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 57049;
...
const x86_mnemonic_variations_fcompp = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fcompp.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcompp;
