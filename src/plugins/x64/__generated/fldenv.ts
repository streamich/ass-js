...
mnemonic_add_0.mnemonic                = "fldenv";
...
const x86_mnemonic_variations_fldenv = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fldenv.defaultOperandSize = 32;

export default x86_mnemonic_variations_fldenv;
