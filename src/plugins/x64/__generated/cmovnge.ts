...
mnemonic_add_0.mnemonic                = "cmovnge";
...
const x86_mnemonic_variations_cmovnge = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovnge.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovnge;
