...
mnemonic_add_0.mnemonic                = "hsubpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688637;
...
const x86_mnemonic_variations_hsubpd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_hsubpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_hsubpd;
