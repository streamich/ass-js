...
mnemonic_add_0.mnemonic                = "maxsd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15863647;
...
const x86_mnemonic_variations_maxsd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_maxsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_maxsd;
