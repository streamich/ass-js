...
mnemonic_add_0.mnemonic                = "vaesenc";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 220;
...
const x86_mnemonic_variations_vaesenc = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vaesenc.defaultOperandSize = 32;

export default x86_mnemonic_variations_vaesenc;
