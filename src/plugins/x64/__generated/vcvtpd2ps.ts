...
mnemonic_add_0.mnemonic                = "vcvtpd2ps";
...
mnemonic_add_1.mnemonic                = "vcvtpd2ps";
...
const x86_mnemonic_variations_vcvtpd2ps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vcvtpd2ps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcvtpd2ps;
