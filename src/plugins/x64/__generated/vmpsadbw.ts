...
mnemonic_add_0.mnemonic                = "vmpsadbw";
...
mnemonic_add_1.mnemonic                = "vmpsadbw";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 66;
...
const x86_mnemonic_variations_vmpsadbw = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vmpsadbw.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmpsadbw;
