...
const x86_mnemonic_variations_addsd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_addsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_addsd;
