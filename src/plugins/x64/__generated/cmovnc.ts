...
mnemonic_add_0.mnemonic                = "cmovnc";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 3907;
...
mnemonic_add_1.mnemonic                = "cmovnc";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 3907;
...
mnemonic_add_2.mnemonic                = "cmovnc";
mnemonic_add_2.operandSize             = 64;
mnemonic_add_2.opcode                  = 3907;
...
const x86_mnemonic_variations_cmovnc = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_cmovnc.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovnc;
