...
mnemonic_add_0.mnemonic                = "vcvttsd2si";
...
mnemonic_add_0.vex                     = {"vvvv":"","L":0,"pp":3,"mmmmm":1,"W":0,"WIG":false};
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = [24];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "vcvttsd2si";
mnemonic_add_1.operandSize             = 64;
mnemonic_add_1.opcode                  = 44;
...
mnemonic_add_1.vex                     = {"vvvv":"","L":0,"pp":3,"mmmmm":1,"W":1,"WIG":false};
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 32;
mnemonic_add_1.extensions              = [24];

const x86_mnemonic_variations_vcvttsd2si = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vcvttsd2si.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcvttsd2si;
