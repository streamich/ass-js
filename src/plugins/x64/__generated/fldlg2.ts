...
mnemonic_add_0.mnemonic                = "fldlg2";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55788;
...
const x86_mnemonic_variations_fldlg2 = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fldlg2.defaultOperandSize = 32;

export default x86_mnemonic_variations_fldlg2;
