...
mnemonic_add_0.mnemonic                = "fldl2t";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55785;
...
const x86_mnemonic_variations_fldl2t = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fldl2t.defaultOperandSize = 32;

export default x86_mnemonic_variations_fldl2t;
