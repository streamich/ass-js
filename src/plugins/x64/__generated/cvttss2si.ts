...
mnemonic_add_0.mnemonic                = "cvttss2si";
...
mnemonic_add_1.mnemonic                = "cvttss2si";
...
const x86_mnemonic_variations_cvttss2si = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_cvttss2si.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvttss2si;
