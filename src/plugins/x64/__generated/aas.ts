...
mnemonic_add_0.mnemonic                = "aas";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 63;
...
const x86_mnemonic_variations_aas = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_aas.defaultOperandSize = 32;

export default x86_mnemonic_variations_aas;
