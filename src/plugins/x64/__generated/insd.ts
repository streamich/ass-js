...
mnemonic_add_0.mnemonic                = "insd";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 109;
...
const x86_mnemonic_variations_insd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_insd.defaultOperandSize = 32;

export default x86_mnemonic_variations_insd;
