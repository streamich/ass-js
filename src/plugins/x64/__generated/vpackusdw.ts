...
mnemonic_add_0.mnemonic                = "vpackusdw";
...
mnemonic_add_0.vex                     = {"vvvv":"NDS","L":0,"pp":1,"mmmmm":2,"W":1,"WIG":true};
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = [24];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "vpackusdw";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 43;
...
mnemonic_add_1.vex                     = {"vvvv":"NDS","L":1,"pp":1,"mmmmm":2,"W":1,"WIG":true};
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 63;
mnemonic_add_1.extensions              = [25];

const x86_mnemonic_variations_vpackusdw = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vpackusdw.defaultOperandSize = 32;

export default x86_mnemonic_variations_vpackusdw;
