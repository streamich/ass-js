...
mnemonic_add_0.mnemonic                = "vcomiss";
...
const x86_mnemonic_variations_vcomiss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vcomiss.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcomiss;
