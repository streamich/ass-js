...
mnemonic_add_0.mnemonic                = "pabsd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 30;
mnemonic_add_0.operandTemplates        = [[a.mm], [a.mm, a.m]];
...
mnemonic_add_0.prefixes                = [15,56];
mnemonic_add_0.opEncoding              = "rm";
mnemonic_add_0.rex                     = null;
mnemonic_add_0.vex                     = null;
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = [19];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "pabsd";
mnemonic_add_1.operandSize             = 128;
mnemonic_add_1.opcode                  = 30;
mnemonic_add_1.operandTemplates        = [[a.xmm], [a.xmm, a.m]];
...
mnemonic_add_1.prefixes                = [102,15,56];
mnemonic_add_1.opEncoding              = "rm";
mnemonic_add_1.rex                     = null;
mnemonic_add_1.vex                     = null;
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 63;
mnemonic_add_1.extensions              = [19];

const x86_mnemonic_variations_pabsd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_pabsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_pabsd;
