...
mnemonic_add_0.mnemonic                = "cmpss";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15929282;
...
const x86_mnemonic_variations_cmpss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmpss.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmpss;
