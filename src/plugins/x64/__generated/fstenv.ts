...
mnemonic_add_0.mnemonic                = "fstenv";
...
const x86_mnemonic_variations_fstenv = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fstenv.defaultOperandSize = 32;

export default x86_mnemonic_variations_fstenv;
