...
mnemonic_add_0.mnemonic                = "clflushopt";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 6688686;
...
const x86_mnemonic_variations_clflushopt = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_clflushopt.defaultOperandSize = 32;

export default x86_mnemonic_variations_clflushopt;
