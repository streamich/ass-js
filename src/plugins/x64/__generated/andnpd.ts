...
mnemonic_add_0.mnemonic                = "andnpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688597;
...
const x86_mnemonic_variations_andnpd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_andnpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_andnpd;
