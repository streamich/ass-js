...
mnemonic_add_0.mnemonic                = "fcomip";
...
const x86_mnemonic_variations_fcomip = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fcomip.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcomip;
