...
mnemonic_add_0.mnemonic                = "movdq2q";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15863766;
mnemonic_add_0.operandTemplates        = [[a.mm], [a.xmm]];
...
const x86_mnemonic_variations_movdq2q = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_movdq2q.defaultOperandSize = 32;

export default x86_mnemonic_variations_movdq2q;
