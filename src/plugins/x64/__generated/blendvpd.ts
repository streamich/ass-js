...
mnemonic_add_0.mnemonic                = "blendvpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997397;
...
const x86_mnemonic_variations_blendvpd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_blendvpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_blendvpd;
