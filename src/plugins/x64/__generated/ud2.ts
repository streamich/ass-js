...
mnemonic_add_0.mnemonic                = "ud2";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 3851;
...
const x86_mnemonic_variations_ud2 = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_ud2.defaultOperandSize = 32;

export default x86_mnemonic_variations_ud2;
