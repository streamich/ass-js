...
mnemonic_add_0.mnemonic                = "vminss";
...
const x86_mnemonic_variations_vminss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vminss.defaultOperandSize = 32;

export default x86_mnemonic_variations_vminss;
