...
mnemonic_add_0.mnemonic                = "cmpxchg";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 4016;
...
mnemonic_add_1.mnemonic                = "cmpxchg";
mnemonic_add_1.operandSize             = 16;
mnemonic_add_1.opcode                  = 4017;
...
mnemonic_add_2.mnemonic                = "cmpxchg";
mnemonic_add_2.operandSize             = 32;
mnemonic_add_2.opcode                  = 4017;
...
mnemonic_add_3.mnemonic                = "cmpxchg";
mnemonic_add_3.operandSize             = 64;
mnemonic_add_3.opcode                  = 4017;
mnemonic_add_3.operandTemplates        = [[a.r, a.m], [a.r]];
...
const x86_mnemonic_variations_cmpxchg = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
    mnemonic_add_3,
]);
x86_mnemonic_variations_cmpxchg.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmpxchg;
