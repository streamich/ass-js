...
mnemonic_add_0.mnemonic                = "cvttps2pi";
...
const x86_mnemonic_variations_cvttps2pi = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvttps2pi.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvttps2pi;
