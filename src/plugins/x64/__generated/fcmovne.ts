...
mnemonic_add_0.mnemonic                = "fcmovne";
...
const x86_mnemonic_variations_fcmovne = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fcmovne.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcmovne;
