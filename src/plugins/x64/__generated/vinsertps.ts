...
mnemonic_add_0.mnemonic                = "vinsertps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 33;
...
const x86_mnemonic_variations_vinsertps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vinsertps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vinsertps;
