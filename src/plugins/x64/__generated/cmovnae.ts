...
mnemonic_add_0.mnemonic                = "cmovnae";
...
const x86_mnemonic_variations_cmovnae = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovnae.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovnae;
