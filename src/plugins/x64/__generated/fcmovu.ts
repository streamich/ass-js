...
mnemonic_add_0.mnemonic                = "fcmovu";
...
const x86_mnemonic_variations_fcmovu = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fcmovu.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcmovu;
