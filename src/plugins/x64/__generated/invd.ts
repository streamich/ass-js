...
mnemonic_add_0.mnemonic                = "invd";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 3848;
...
const x86_mnemonic_variations_invd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_invd.defaultOperandSize = 32;

export default x86_mnemonic_variations_invd;
