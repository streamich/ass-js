...
mnemonic_add_0.mnemonic                = "vcvtss2sd";
...
const x86_mnemonic_variations_vcvtss2sd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vcvtss2sd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcvtss2sd;
