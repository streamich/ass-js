...
mnemonic_add_0.mnemonic                = "jne";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 117;
...
mnemonic_add_1.mnemonic                = "jne";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 3973;
...
const x86_mnemonic_variations_jne = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jne.defaultOperandSize = 32;

export default x86_mnemonic_variations_jne;
