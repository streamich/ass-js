...
mnemonic_add_0.mnemonic                = "jnbe";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 119;
...
mnemonic_add_1.mnemonic                = "jnbe";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 3975;
...
const x86_mnemonic_variations_jnbe = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jnbe.defaultOperandSize = 32;

export default x86_mnemonic_variations_jnbe;
