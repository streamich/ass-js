...
mnemonic_add_0.mnemonic                = "cvtpd2ps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688602;
...
const x86_mnemonic_variations_cvtpd2ps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtpd2ps.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtpd2ps;
