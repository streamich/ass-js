...
mnemonic_add_0.mnemonic                = "prefetchwt1";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 3853;
...
const x86_mnemonic_variations_prefetchwt1 = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_prefetchwt1.defaultOperandSize = 32;

export default x86_mnemonic_variations_prefetchwt1;
