...
mnemonic_add_0.mnemonic                = "cvtpi2ps";
...
const x86_mnemonic_variations_cvtpi2ps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtpi2ps.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtpi2ps;
