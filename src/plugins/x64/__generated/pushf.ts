...
mnemonic_add_0.mnemonic                = "pushf";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 156;
...
const x86_mnemonic_variations_pushf = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_pushf.defaultOperandSize = 32;

export default x86_mnemonic_variations_pushf;
