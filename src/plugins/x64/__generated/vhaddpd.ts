...
mnemonic_add_0.mnemonic                = "vhaddpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 124;
...
mnemonic_add_1.mnemonic                = "vhaddpd";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 124;
...
const x86_mnemonic_variations_vhaddpd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vhaddpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vhaddpd;
