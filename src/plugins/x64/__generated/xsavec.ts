...
mnemonic_add_0.mnemonic                = "xsavec";
...
const x86_mnemonic_variations_xsavec = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_xsavec.defaultOperandSize = 32;

export default x86_mnemonic_variations_xsavec;
