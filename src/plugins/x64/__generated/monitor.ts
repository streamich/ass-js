...
mnemonic_add_0.mnemonic                = "monitor";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 983496;
...
const x86_mnemonic_variations_monitor = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_monitor.defaultOperandSize = 32;

export default x86_mnemonic_variations_monitor;
