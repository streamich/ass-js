...
mnemonic_add_0.mnemonic                = "ftst";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55780;
...
const x86_mnemonic_variations_ftst = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_ftst.defaultOperandSize = 32;

export default x86_mnemonic_variations_ftst;
