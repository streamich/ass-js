...
mnemonic_add_0.mnemonic                = "cli";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 250;
...
const x86_mnemonic_variations_cli = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cli.defaultOperandSize = 32;

export default x86_mnemonic_variations_cli;
