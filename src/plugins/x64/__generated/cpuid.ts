...
mnemonic_add_0.mnemonic                = "cpuid";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 4002;
...
const x86_mnemonic_variations_cpuid = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cpuid.defaultOperandSize = 32;

export default x86_mnemonic_variations_cpuid;
