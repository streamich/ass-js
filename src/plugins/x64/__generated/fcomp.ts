...
mnemonic_add_2.mnemonic                = "fcomp";
mnemonic_add_2.operandSize             = 80;
mnemonic_add_2.opcode                  = 216;
mnemonic_add_2.operandTemplates        = [[a.st]];
...
mnemonic_add_3.mnemonic                = "fcomp";
mnemonic_add_3.operandSize             = 0;
mnemonic_add_3.opcode                  = 55513;
...
const x86_mnemonic_variations_fcomp = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
    mnemonic_add_3,
]);
x86_mnemonic_variations_fcomp.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcomp;
