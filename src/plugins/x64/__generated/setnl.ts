...
const x86_mnemonic_variations_setnl = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setnl.defaultOperandSize = 32;

export default x86_mnemonic_variations_setnl;
