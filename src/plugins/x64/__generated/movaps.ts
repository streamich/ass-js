...
mnemonic_add_0.mnemonic                = "movaps";
...
mnemonic_add_1.mnemonic                = "movaps";
...
const x86_mnemonic_variations_movaps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_movaps.defaultOperandSize = 32;

export default x86_mnemonic_variations_movaps;
