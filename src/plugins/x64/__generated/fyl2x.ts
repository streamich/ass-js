...
mnemonic_add_0.mnemonic                = "fyl2x";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55793;
...
const x86_mnemonic_variations_fyl2x = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fyl2x.defaultOperandSize = 32;

export default x86_mnemonic_variations_fyl2x;
