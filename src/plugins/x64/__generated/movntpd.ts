...
mnemonic_add_0.mnemonic                = "movntpd";
...
const x86_mnemonic_variations_movntpd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_movntpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_movntpd;
