...
mnemonic_add_0.mnemonic                = "aesenc";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997596;
...
const x86_mnemonic_variations_aesenc = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_aesenc.defaultOperandSize = 32;

export default x86_mnemonic_variations_aesenc;
