...
mnemonic_add_0.mnemonic                = "addps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3928;
...
const x86_mnemonic_variations_addps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_addps.defaultOperandSize = 32;

export default x86_mnemonic_variations_addps;
