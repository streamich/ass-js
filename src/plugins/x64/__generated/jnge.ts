...
mnemonic_add_1.mnemonic                = "jnge";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 3980;
...
const x86_mnemonic_variations_jnge = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jnge.defaultOperandSize = 32;

export default x86_mnemonic_variations_jnge;
