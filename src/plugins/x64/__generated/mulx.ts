...
mnemonic_add_0.mnemonic                = "mulx";
mnemonic_add_0.operandSize             = 32;
mnemonic_add_0.opcode                  = 246;
mnemonic_add_0.operandTemplates        = [[a.r], [a.r], [a.r, a.m]];
...
mnemonic_add_0.vex                     = {"vvvv":"NDD","L":0,"pp":3,"mmmmm":2,"W":0,"WIG":false};
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = [10];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "mulx";
mnemonic_add_1.operandSize             = 64;
mnemonic_add_1.opcode                  = 246;
mnemonic_add_1.operandTemplates        = [[a.r], [a.r], [a.r, a.m]];
...
mnemonic_add_1.vex                     = {"vvvv":"NDD","L":0,"pp":3,"mmmmm":2,"W":1,"WIG":false};
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 63;
mnemonic_add_1.extensions              = [10];

const x86_mnemonic_variations_mulx = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_mulx.defaultOperandSize = 32;

export default x86_mnemonic_variations_mulx;
