...
mnemonic_add_0.mnemonic                = "fxsave";
...
const x86_mnemonic_variations_fxsave = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fxsave.defaultOperandSize = 32;

export default x86_mnemonic_variations_fxsave;
