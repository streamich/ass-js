...
mnemonic_add_0.mnemonic                = "fsqrt";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55802;
...
const x86_mnemonic_variations_fsqrt = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fsqrt.defaultOperandSize = 32;

export default x86_mnemonic_variations_fsqrt;
