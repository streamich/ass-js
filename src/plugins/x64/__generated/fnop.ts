...
mnemonic_add_0.mnemonic                = "fnop";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55760;
...
const x86_mnemonic_variations_fnop = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fnop.defaultOperandSize = 32;

export default x86_mnemonic_variations_fnop;
