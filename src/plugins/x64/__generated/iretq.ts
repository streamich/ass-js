...
mnemonic_add_0.mnemonic                = "iretq";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 207;
...
mnemonic_add_0.rex                     = [1,0,0,0];
mnemonic_add_0.vex                     = null;
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = null;

const x86_mnemonic_variations_iretq = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_iretq.defaultOperandSize = 32;

export default x86_mnemonic_variations_iretq;
