...
mnemonic_add_0.mnemonic                = "andn";
mnemonic_add_0.operandSize             = 32;
mnemonic_add_0.opcode                  = 242;
...
mnemonic_add_1.mnemonic                = "andn";
mnemonic_add_1.operandSize             = 64;
mnemonic_add_1.opcode                  = 242;
...
const x86_mnemonic_variations_andn = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_andn.defaultOperandSize = 32;

export default x86_mnemonic_variations_andn;
