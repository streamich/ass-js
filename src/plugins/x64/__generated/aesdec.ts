...
mnemonic_add_0.mnemonic                = "aesdec";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997598;
...
const x86_mnemonic_variations_aesdec = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_aesdec.defaultOperandSize = 32;

export default x86_mnemonic_variations_aesdec;
