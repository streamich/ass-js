...
mnemonic_add_0.mnemonic                = "frstor";
...
const x86_mnemonic_variations_frstor = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_frstor.defaultOperandSize = 32;

export default x86_mnemonic_variations_frstor;
