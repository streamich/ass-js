...
mnemonic_add_0.mnemonic                = "bsf";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 4028;
...
mnemonic_add_1.mnemonic                = "bsf";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 4028;
...
mnemonic_add_2.mnemonic                = "bsf";
mnemonic_add_2.operandSize             = 64;
mnemonic_add_2.opcode                  = 4028;
...
const x86_mnemonic_variations_bsf = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_bsf.defaultOperandSize = 32;

export default x86_mnemonic_variations_bsf;
