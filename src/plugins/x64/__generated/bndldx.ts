...
mnemonic_add_0.mnemonic                = "bndldx";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3866;
...
const x86_mnemonic_variations_bndldx = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_bndldx.defaultOperandSize = 32;

export default x86_mnemonic_variations_bndldx;
