...
mnemonic_add_0.mnemonic                = "clts";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 3846;
...
const x86_mnemonic_variations_clts = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_clts.defaultOperandSize = 32;

export default x86_mnemonic_variations_clts;
