...
mnemonic_add_0.mnemonic                = "addsubps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15863760;
...
const x86_mnemonic_variations_addsubps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_addsubps.defaultOperandSize = 32;

export default x86_mnemonic_variations_addsubps;
