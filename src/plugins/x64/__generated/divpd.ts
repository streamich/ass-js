...
mnemonic_add_0.mnemonic                = "divpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688606;
...
const x86_mnemonic_variations_divpd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_divpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_divpd;
