...
mnemonic_add_0.mnemonic                = "vcmpsd";
...
const x86_mnemonic_variations_vcmpsd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vcmpsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcmpsd;
