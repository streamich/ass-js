...
mnemonic_add_0.mnemonic                = "fcmovnbe";
...
const x86_mnemonic_variations_fcmovnbe = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fcmovnbe.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcmovnbe;
