...
mnemonic_add_0.mnemonic                = "cmovg";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 3919;
...
mnemonic_add_1.mnemonic                = "cmovg";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 3919;
...
mnemonic_add_2.mnemonic                = "cmovg";
mnemonic_add_2.operandSize             = 64;
mnemonic_add_2.opcode                  = 3919;
...
const x86_mnemonic_variations_cmovg = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_cmovg.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovg;
