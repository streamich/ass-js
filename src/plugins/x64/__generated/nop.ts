...
mnemonic_add_1.mnemonic                = "nop";
mnemonic_add_1.operandSize             = 16;
mnemonic_add_1.opcode                  = 3871;
...
mnemonic_add_2.mnemonic                = "nop";
mnemonic_add_2.operandSize             = 32;
mnemonic_add_2.opcode                  = 3871;
...
const x86_mnemonic_variations_nop = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
]);
x86_mnemonic_variations_nop.defaultOperandSize = 32;

export default x86_mnemonic_variations_nop;
