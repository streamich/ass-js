...
mnemonic_add_0.mnemonic                = "sti";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 251;
...
const x86_mnemonic_variations_sti = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_sti.defaultOperandSize = 32;

export default x86_mnemonic_variations_sti;
