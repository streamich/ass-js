...
mnemonic_add_0.mnemonic                = "cmovpe";
...
const x86_mnemonic_variations_cmovpe = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovpe.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovpe;
