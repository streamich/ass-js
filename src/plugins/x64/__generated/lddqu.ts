...
mnemonic_add_0.mnemonic                = "lddqu";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15863792;
...
const x86_mnemonic_variations_lddqu = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_lddqu.defaultOperandSize = 32;

export default x86_mnemonic_variations_lddqu;
