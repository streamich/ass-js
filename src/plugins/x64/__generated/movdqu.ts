...
mnemonic_add_0.mnemonic                = "movdqu";
...
mnemonic_add_0.prefixes                = [243,15];
...
mnemonic_add_1.mnemonic                = "movdqu";
...
mnemonic_add_1.prefixes                = [243,15];
...
const x86_mnemonic_variations_movdqu = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_movdqu.defaultOperandSize = 32;

export default x86_mnemonic_variations_movdqu;
