...
mnemonic_add_0.mnemonic                = "cvttps2dq";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15929179;
...
const x86_mnemonic_variations_cvttps2dq = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvttps2dq.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvttps2dq;
