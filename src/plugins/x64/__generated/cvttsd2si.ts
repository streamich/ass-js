...
mnemonic_add_0.mnemonic                = "cvttsd2si";
mnemonic_add_0.operandSize             = 32;
mnemonic_add_0.opcode                  = 3884;
...
mnemonic_add_1.mnemonic                = "cvttsd2si";
mnemonic_add_1.operandSize             = 64;
mnemonic_add_1.opcode                  = 3884;
...
mnemonic_add_1.extensions              = [17];

const x86_mnemonic_variations_cvttsd2si = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_cvttsd2si.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvttsd2si;
