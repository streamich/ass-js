...
mnemonic_add_3.mnemonic                = "fcom";
mnemonic_add_3.operandSize             = 0;
mnemonic_add_3.opcode                  = 55505;
...
const x86_mnemonic_variations_fcom = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
    mnemonic_add_2,
    mnemonic_add_3,
]);
x86_mnemonic_variations_fcom.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcom;
