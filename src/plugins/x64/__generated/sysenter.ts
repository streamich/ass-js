...
mnemonic_add_0.mnemonic                = "sysenter";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 3892;
...
const x86_mnemonic_variations_sysenter = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_sysenter.defaultOperandSize = 32;

export default x86_mnemonic_variations_sysenter;
