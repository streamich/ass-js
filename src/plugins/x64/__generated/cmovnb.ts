...
mnemonic_add_0.mnemonic                = "cmovnb";
...
const x86_mnemonic_variations_cmovnb = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovnb.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovnb;
