...
mnemonic_add_0.mnemonic                = "movq2dq";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15929302;
mnemonic_add_0.operandTemplates        = [[a.xmm], [a.mm]];
...
const x86_mnemonic_variations_movq2dq = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_movq2dq.defaultOperandSize = 32;

export default x86_mnemonic_variations_movq2dq;
