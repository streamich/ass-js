...
mnemonic_add_0.mnemonic                = "popf";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 157;
...
const x86_mnemonic_variations_popf = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_popf.defaultOperandSize = 32;

export default x86_mnemonic_variations_popf;
