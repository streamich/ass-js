...
mnemonic_add_0.mnemonic                = "setae";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3987;
...
const x86_mnemonic_variations_setae = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setae.defaultOperandSize = 32;

export default x86_mnemonic_variations_setae;
