...
mnemonic_add_0.mnemonic                = "cmovng";
...
const x86_mnemonic_variations_cmovng = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovng.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovng;
