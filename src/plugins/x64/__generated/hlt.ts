...
mnemonic_add_0.mnemonic                = "hlt";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 244;
...
const x86_mnemonic_variations_hlt = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_hlt.defaultOperandSize = 32;

export default x86_mnemonic_variations_hlt;
