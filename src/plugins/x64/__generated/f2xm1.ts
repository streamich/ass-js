...
mnemonic_add_0.mnemonic                = "f2xm1";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55792;
...
const x86_mnemonic_variations_f2xm1 = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_f2xm1.defaultOperandSize = 32;

export default x86_mnemonic_variations_f2xm1;
