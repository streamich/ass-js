...
mnemonic_add_0.mnemonic                = "aesenclast";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997597;
...
const x86_mnemonic_variations_aesenclast = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_aesenclast.defaultOperandSize = 32;

export default x86_mnemonic_variations_aesenclast;
