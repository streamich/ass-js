...
mnemonic_add_0.mnemonic                = "jle";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 126;
...
mnemonic_add_1.mnemonic                = "jle";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 3982;
...
const x86_mnemonic_variations_jle = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jle.defaultOperandSize = 32;

export default x86_mnemonic_variations_jle;
