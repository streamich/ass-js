...
mnemonic_add_0.mnemonic                = "movlpd";
...
mnemonic_add_1.mnemonic                = "movlpd";
...
const x86_mnemonic_variations_movlpd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_movlpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_movlpd;
