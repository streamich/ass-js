...
mnemonic_add_0.mnemonic                = "comisd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688559;
...
const x86_mnemonic_variations_comisd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_comisd.defaultOperandSize = 32;

export default x86_mnemonic_variations_comisd;
