...
mnemonic_add_0.mnemonic                = "insertps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997921;
...
const x86_mnemonic_variations_insertps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_insertps.defaultOperandSize = 32;

export default x86_mnemonic_variations_insertps;
