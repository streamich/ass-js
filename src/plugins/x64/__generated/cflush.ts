...
mnemonic_add_0.mnemonic                = "cflush";
...
const x86_mnemonic_variations_cflush = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cflush.defaultOperandSize = 32;

export default x86_mnemonic_variations_cflush;
