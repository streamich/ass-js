...
mnemonic_add_0.mnemonic                = "fsincos";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55803;
...
const x86_mnemonic_variations_fsincos = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fsincos.defaultOperandSize = 32;

export default x86_mnemonic_variations_fsincos;
