...
mnemonic_add_0.mnemonic                = "jnae";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 114;
...
mnemonic_add_1.mnemonic                = "jnae";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 3970;
...
const x86_mnemonic_variations_jnae = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jnae.defaultOperandSize = 32;

export default x86_mnemonic_variations_jnae;
