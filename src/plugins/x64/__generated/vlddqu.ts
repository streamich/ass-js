...
mnemonic_add_0.mnemonic                = "vlddqu";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 240;
...
mnemonic_add_0.vex                     = {"vvvv":"","L":0,"pp":3,"mmmmm":1,"W":1,"WIG":true};
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = [24];

const mnemonic_add_1 = new MnemonicX86;
mnemonic_add_1.mnemonic                = "vlddqu";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 240;
mnemonic_add_1.operandTemplates        = [[a.ymm], [a.m]];
...
mnemonic_add_1.vex                     = {"vvvv":"","L":1,"pp":3,"mmmmm":1,"W":1,"WIG":true};
mnemonic_add_1.evex                    = null;
mnemonic_add_1.mode                    = 63;
mnemonic_add_1.extensions              = [24];

const x86_mnemonic_variations_vlddqu = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vlddqu.defaultOperandSize = 32;

export default x86_mnemonic_variations_vlddqu;
