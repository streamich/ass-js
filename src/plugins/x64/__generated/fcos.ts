...
mnemonic_add_0.mnemonic                = "fcos";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55807;
...
const x86_mnemonic_variations_fcos = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fcos.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcos;
