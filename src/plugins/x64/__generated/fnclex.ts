...
mnemonic_add_0.mnemonic                = "fnclex";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 56290;
...
const x86_mnemonic_variations_fnclex = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fnclex.defaultOperandSize = 32;

export default x86_mnemonic_variations_fnclex;
