...
mnemonic_add_0.mnemonic                = "fnsave";
...
const x86_mnemonic_variations_fnsave = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fnsave.defaultOperandSize = 32;

export default x86_mnemonic_variations_fnsave;
