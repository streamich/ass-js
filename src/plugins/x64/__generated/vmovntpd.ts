...
mnemonic_add_0.mnemonic                = "vmovntpd";
...
mnemonic_add_1.mnemonic                = "vmovntpd";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 43;
mnemonic_add_1.operandTemplates        = [[a.m], [a.ymm]];
...
const x86_mnemonic_variations_vmovntpd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vmovntpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmovntpd;
