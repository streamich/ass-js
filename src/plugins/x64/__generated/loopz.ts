...
const x86_mnemonic_variations_loopz = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_loopz.defaultOperandSize = 32;

export default x86_mnemonic_variations_loopz;
