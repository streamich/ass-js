...
mnemonic_add_0.mnemonic                = "vaddsubpd";
...
mnemonic_add_1.mnemonic                = "vaddsubpd";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 208;
...
const x86_mnemonic_variations_vaddsubpd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vaddsubpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vaddsubpd;
