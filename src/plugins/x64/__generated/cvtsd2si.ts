...
mnemonic_add_0.mnemonic                = "cvtsd2si";
mnemonic_add_0.operandSize             = 32;
mnemonic_add_0.opcode                  = 15863597;
...
const x86_mnemonic_variations_cvtsd2si = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtsd2si.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtsd2si;
