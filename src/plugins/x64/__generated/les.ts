...
mnemonic_add_0.mnemonic                = "les";
mnemonic_add_0.operandSize             = 16;
mnemonic_add_0.opcode                  = 196;
...
mnemonic_add_1.mnemonic                = "les";
mnemonic_add_1.operandSize             = 32;
mnemonic_add_1.opcode                  = 196;
...
const x86_mnemonic_variations_les = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_les.defaultOperandSize = 32;

export default x86_mnemonic_variations_les;
