...
mnemonic_add_0.mnemonic                = "setne";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3989;
...
const x86_mnemonic_variations_setne = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setne.defaultOperandSize = 32;

export default x86_mnemonic_variations_setne;
