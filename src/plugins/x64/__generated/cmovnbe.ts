...
mnemonic_add_0.mnemonic                = "cmovnbe";
...
const x86_mnemonic_variations_cmovnbe = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovnbe.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovnbe;
