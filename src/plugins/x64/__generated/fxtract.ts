...
mnemonic_add_0.mnemonic                = "fxtract";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55796;
...
const x86_mnemonic_variations_fxtract = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fxtract.defaultOperandSize = 32;

export default x86_mnemonic_variations_fxtract;
