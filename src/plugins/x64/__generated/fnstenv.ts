...
mnemonic_add_0.mnemonic                = "fnstenv";
...
const x86_mnemonic_variations_fnstenv = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fnstenv.defaultOperandSize = 32;

export default x86_mnemonic_variations_fnstenv;
