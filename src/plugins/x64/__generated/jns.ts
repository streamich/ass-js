...
mnemonic_add_0.mnemonic                = "jns";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 121;
...
mnemonic_add_1.mnemonic                = "jns";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 3977;
...
const x86_mnemonic_variations_jns = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_jns.defaultOperandSize = 32;

export default x86_mnemonic_variations_jns;
