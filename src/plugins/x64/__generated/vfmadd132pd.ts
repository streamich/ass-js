...
mnemonic_add_0.mnemonic                = "vfmadd132pd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 152;
...
mnemonic_add_0.vex                     = {"vvvv":"DDS","L":0,"pp":1,"mmmmm":2,"W":1,"WIG":false};
mnemonic_add_0.evex                    = null;
mnemonic_add_0.mode                    = 63;
mnemonic_add_0.extensions              = null;

const x86_mnemonic_variations_vfmadd132pd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vfmadd132pd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vfmadd132pd;
