...
mnemonic_add_0.mnemonic                = "aad";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 54538;
...
mnemonic_add_1.mnemonic                = "aad";
mnemonic_add_1.operandSize             = 0;
mnemonic_add_1.opcode                  = 213;
mnemonic_add_1.operandTemplates        = [[a.imm8]];
...
const x86_mnemonic_variations_aad = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_aad.defaultOperandSize = 32;

export default x86_mnemonic_variations_aad;
