...
mnemonic_add_0.mnemonic                = "vaesdeclast";
...
const x86_mnemonic_variations_vaesdeclast = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vaesdeclast.defaultOperandSize = 32;

export default x86_mnemonic_variations_vaesdeclast;
