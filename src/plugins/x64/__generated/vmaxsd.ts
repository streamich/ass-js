...
mnemonic_add_0.mnemonic                = "vmaxsd";
...
const x86_mnemonic_variations_vmaxsd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vmaxsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmaxsd;
