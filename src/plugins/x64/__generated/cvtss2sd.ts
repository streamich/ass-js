...
mnemonic_add_0.mnemonic                = "cvtss2sd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15929178;
...
const x86_mnemonic_variations_cvtss2sd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cvtss2sd.defaultOperandSize = 32;

export default x86_mnemonic_variations_cvtss2sd;
