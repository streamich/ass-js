...
mnemonic_add_0.mnemonic                = "vmaxpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 95;
...
mnemonic_add_1.mnemonic                = "vmaxpd";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 95;
...
const x86_mnemonic_variations_vmaxpd = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vmaxpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmaxpd;
