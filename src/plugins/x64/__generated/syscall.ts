...
mnemonic_add_0.mnemonic                = "syscall";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 3845;
...
const x86_mnemonic_variations_syscall = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_syscall.defaultOperandSize = 32;

export default x86_mnemonic_variations_syscall;
