...
mnemonic_add_0.mnemonic                = "vmulsd";
...
const x86_mnemonic_variations_vmulsd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_vmulsd.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmulsd;
