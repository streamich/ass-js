...
const x86_mnemonic_variations_lodsb = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_lodsb.defaultOperandSize = 32;

export default x86_mnemonic_variations_lodsb;
