...
mnemonic_add_0.mnemonic                = "daa";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 39;
...
const x86_mnemonic_variations_daa = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_daa.defaultOperandSize = 32;

export default x86_mnemonic_variations_daa;
