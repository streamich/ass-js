...
mnemonic_add_0.mnemonic                = "fptan";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55794;
...
const x86_mnemonic_variations_fptan = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fptan.defaultOperandSize = 32;

export default x86_mnemonic_variations_fptan;
