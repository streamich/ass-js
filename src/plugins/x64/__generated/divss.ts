...
mnemonic_add_0.mnemonic                = "divss";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 15929182;
...
const x86_mnemonic_variations_divss = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_divss.defaultOperandSize = 32;

export default x86_mnemonic_variations_divss;
