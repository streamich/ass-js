...
mnemonic_add_0.mnemonic                = "packusdw";
...
mnemonic_add_0.prefixes                = [102,15,56];
...
const x86_mnemonic_variations_packusdw = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_packusdw.defaultOperandSize = 32;

export default x86_mnemonic_variations_packusdw;
