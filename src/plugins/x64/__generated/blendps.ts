...
mnemonic_add_0.mnemonic                = "blendps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997900;
...
const x86_mnemonic_variations_blendps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_blendps.defaultOperandSize = 32;

export default x86_mnemonic_variations_blendps;
