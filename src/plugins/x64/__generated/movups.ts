...
mnemonic_add_0.mnemonic                = "movups";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3856;
...
mnemonic_add_1.mnemonic                = "movups";
mnemonic_add_1.operandSize             = 128;
mnemonic_add_1.opcode                  = 3857;
...
const x86_mnemonic_variations_movups = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_movups.defaultOperandSize = 32;

export default x86_mnemonic_variations_movups;
