...
mnemonic_add_0.mnemonic                = "setno";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3985;
...
const x86_mnemonic_variations_setno = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setno.defaultOperandSize = 32;

export default x86_mnemonic_variations_setno;
