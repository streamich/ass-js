...
mnemonic_add_0.mnemonic                = "blendpd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 997903;
...
const x86_mnemonic_variations_blendpd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_blendpd.defaultOperandSize = 32;

export default x86_mnemonic_variations_blendpd;
