...
mnemonic_add_0.mnemonic                = "xgetbv";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 983504;
...
const x86_mnemonic_variations_xgetbv = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_xgetbv.defaultOperandSize = 32;

export default x86_mnemonic_variations_xgetbv;
