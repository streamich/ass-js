...
mnemonic_add_0.mnemonic                = "divps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3934;
...
const x86_mnemonic_variations_divps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_divps.defaultOperandSize = 32;

export default x86_mnemonic_variations_divps;
