...
mnemonic_add_0.mnemonic                = "fcmovnu";
...
const x86_mnemonic_variations_fcmovnu = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fcmovnu.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcmovnu;
