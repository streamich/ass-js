...
mnemonic_add_0.mnemonic                = "seta";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3991;
...
const x86_mnemonic_variations_seta = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_seta.defaultOperandSize = 32;

export default x86_mnemonic_variations_seta;
