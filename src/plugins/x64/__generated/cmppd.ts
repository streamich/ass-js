...
mnemonic_add_0.mnemonic                = "cmppd";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 6688706;
...
const x86_mnemonic_variations_cmppd = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmppd.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmppd;
