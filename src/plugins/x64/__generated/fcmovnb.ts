...
mnemonic_add_0.mnemonic                = "fcmovnb";
...
const x86_mnemonic_variations_fcmovnb = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fcmovnb.defaultOperandSize = 32;

export default x86_mnemonic_variations_fcmovnb;
