...
mnemonic_add_0.mnemonic                = "setbe";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3990;
...
const x86_mnemonic_variations_setbe = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setbe.defaultOperandSize = 32;

export default x86_mnemonic_variations_setbe;
