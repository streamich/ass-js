...
mnemonic_add_0.mnemonic                = "setnge";
...
const x86_mnemonic_variations_setnge = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setnge.defaultOperandSize = 32;

export default x86_mnemonic_variations_setnge;
