...
mnemonic_add_0.mnemonic                = "sysexit";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 3893;
...
const x86_mnemonic_variations_sysexit = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_sysexit.defaultOperandSize = 32;

export default x86_mnemonic_variations_sysexit;
