...
mnemonic_add_0.mnemonic                = "lfence";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 1027816;
...
const x86_mnemonic_variations_lfence = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_lfence.defaultOperandSize = 32;

export default x86_mnemonic_variations_lfence;
