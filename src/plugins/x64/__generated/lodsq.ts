...
mnemonic_add_0.mnemonic                = "lodsq";
mnemonic_add_0.operandSize             = 64;
mnemonic_add_0.opcode                  = 173;
...
const x86_mnemonic_variations_lodsq = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_lodsq.defaultOperandSize = 32;

export default x86_mnemonic_variations_lodsq;
