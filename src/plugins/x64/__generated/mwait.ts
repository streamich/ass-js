...
mnemonic_add_0.mnemonic                = "mwait";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 983497;
...
const x86_mnemonic_variations_mwait = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_mwait.defaultOperandSize = 32;

export default x86_mnemonic_variations_mwait;
