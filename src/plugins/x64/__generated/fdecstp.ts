...
mnemonic_add_0.mnemonic                = "fdecstp";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 55798;
...
const x86_mnemonic_variations_fdecstp = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fdecstp.defaultOperandSize = 32;

export default x86_mnemonic_variations_fdecstp;
