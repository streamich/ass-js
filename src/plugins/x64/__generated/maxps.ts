...
mnemonic_add_0.mnemonic                = "maxps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 3935;
...
const x86_mnemonic_variations_maxps = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_maxps.defaultOperandSize = 32;

export default x86_mnemonic_variations_maxps;
