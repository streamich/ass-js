...
mnemonic_add_0.mnemonic                = "vcvtpd2dq";
...
mnemonic_add_1.mnemonic                = "vcvtpd2dq";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 230;
...
const x86_mnemonic_variations_vcvtpd2dq = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vcvtpd2dq.defaultOperandSize = 32;

export default x86_mnemonic_variations_vcvtpd2dq;
