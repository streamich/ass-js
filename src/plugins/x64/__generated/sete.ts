...
mnemonic_add_0.mnemonic                = "sete";
mnemonic_add_0.operandSize             = 8;
mnemonic_add_0.opcode                  = 3988;
...
const x86_mnemonic_variations_sete = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_sete.defaultOperandSize = 32;

export default x86_mnemonic_variations_sete;
