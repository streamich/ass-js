...
mnemonic_add_0.mnemonic                = "vmovmskps";
mnemonic_add_0.operandSize             = 128;
mnemonic_add_0.opcode                  = 80;
mnemonic_add_0.operandTemplates        = [[a.r], [a.xmm]];
...
mnemonic_add_1.mnemonic                = "vmovmskps";
mnemonic_add_1.operandSize             = 256;
mnemonic_add_1.opcode                  = 80;
mnemonic_add_1.operandTemplates        = [[a.r], [a.ymm]];
...
const x86_mnemonic_variations_vmovmskps = new MnemonicVariationsX86([
    mnemonic_add_0,
    mnemonic_add_1,
]);
x86_mnemonic_variations_vmovmskps.defaultOperandSize = 32;

export default x86_mnemonic_variations_vmovmskps;
