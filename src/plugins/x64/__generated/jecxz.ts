...
mnemonic_add_0.mnemonic                = "jecxz";
mnemonic_add_0.operandSize             = 0;
mnemonic_add_0.opcode                  = 227;
...
const x86_mnemonic_variations_jecxz = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_jecxz.defaultOperandSize = 32;

export default x86_mnemonic_variations_jecxz;
