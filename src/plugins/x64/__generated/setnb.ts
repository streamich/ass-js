...
const x86_mnemonic_variations_setnb = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_setnb.defaultOperandSize = 32;

export default x86_mnemonic_variations_setnb;
