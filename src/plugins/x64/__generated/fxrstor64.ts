...
mnemonic_add_0.mnemonic                = "fxrstor64";
mnemonic_add_0.operandSize             = 512;
...
const x86_mnemonic_variations_fxrstor64 = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_fxrstor64.defaultOperandSize = 32;

export default x86_mnemonic_variations_fxrstor64;
