...
mnemonic_add_0.mnemonic                = "cmpxchg8b";
...
const x86_mnemonic_variations_cmpxchg8b = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmpxchg8b.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmpxchg8b;
