...
mnemonic_add_0.mnemonic                = "cmovnle";
...
const x86_mnemonic_variations_cmovnle = new MnemonicVariationsX86([
    mnemonic_add_0,
]);
x86_mnemonic_variations_cmovnle.defaultOperandSize = 32;

export default x86_mnemonic_variations_cmovnle;
