...
var SYS_clone = 56;
var SYS_exit = 60;
var SYS_sched_yield = 24;
var STDOUT = 1;
var CLONE_VM = 0x00000100;
var CLONE_FS = 0x00000200;
var CLONE_FILES = 0x00000400;
var CLONE_SIGHAND = 0x00000800;
var CLONE_PARENT = 0x00008000;
...
var PROT_WRITE = 0x2;
var PROT_EXEC = 0x4;
var THREAD_FLAGS = CLONE_VM | CLONE_FS | CLONE_FILES | CLONE_SIGHAND | CLONE_PARENT | CLONE_THREAD | CLONE_IO;
var STACK_SIZE = 4096 * 1024;
var MAX_LINES = 10000;
function syscall(code) { code._('syscall'); }
