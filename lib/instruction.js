...
var ExpressionVariable = (function (_super) {
    ...
    function ExpressionVariable(ops) {
        ...
        var _this = _super.call(this) || this;
        _this.ops = null; // Operands provided by user.
...
var Instruction = (function (_super) {
    ...
    function Instruction() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.def = null; // Definition on how to construct this instruction.
        _this.opts = null; // Instruction options provided by user.
        return _this;
    }
...
var InstructionSet = (function (_super) {
    ...
    function InstructionSet(ops, matches, opts) {
        ...
        _this.matches = null;
        _this.insn = [];
        _this.picked = -1; // Index of instruction that was eventually chosen.
        _this.opts = null; // Instruction options provided by user.
